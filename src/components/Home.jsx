  ...
  return (
    <Box>
      ...
      <Container maxW={'container.xl'} minH={'100vh'} p="16">
        ...
        <Stack
          h="full"
          p={['4']} // Adjust padding for different screen sizes
          spacing={8} // Add spacing between Image and Text on medium screens
          alignItems={'center'}
          direction={['column', 'row']}
        >
          <Image src={img5} h={['40', '400']} filter={'hue-rotate(-110deg)'} />
